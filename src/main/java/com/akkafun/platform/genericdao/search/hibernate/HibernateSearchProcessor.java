...
import com.akkafun.platform.genericdao.search.*;
 ...
 * be accessed using {@link com.akkafun.platform.genericdao.search.hibernate.HibernateSearchProcessor#getInstanceForSessionFactory(SessionFactory)}.
 * 
 * @author dwolverton
 */
