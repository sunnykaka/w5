 ...
 */
package com.akkafun.platform.genericdao.search;

import static com.akkafun.platform.genericdao.search.ISearch.RESULT_ARRAY;
import static com.akkafun.platform.genericdao.search.ISearch.RESULT_AUTO;
import static com.akkafun.platform.genericdao.search.ISearch.RESULT_LIST;
import static com.akkafun.platform.genericdao.search.ISearch.RESULT_MAP;
import static com.akkafun.platform.genericdao.search.ISearch.RESULT_SINGLE;
...
public class SearchUtil {
	 ...
	 * Add a filter that uses a custom expression.
	 * 
	 * @see {@link Filter#custom(String, java.util.Collection)}
	 */
